	...
	return (
		<Layout>
			<div className="container mt-5">
				...
				<p>Welcome to danut-Shop! </p>

				<p>
					These terms and conditions outline the rules and regulations for the use of <b>danut-Shop's</b>{' '}
					Website, located at www.danut-shop.ro.
				</p>

				<p>
					By accessing this website we assume you accept these terms and conditions. Do not continue to use
					danut-Shop if you do not agree to take all of the terms and conditions stated on this page.
				</p>
				...
				<p>
					We employ the use of cookies. By accessing danut-Shop, you agreed to use cookies in agreement with
					the danut-Shop's Privacy Policy.{' '}
				</p>
				...
				<p>
					Unless otherwise stated, danut-Shop and/or its licensors own the intellectual property rights for
					all material on danut-Shop. All intellectual property rights are reserved. You may access this from
					danut-Shop for your own personal use subjected to restrictions set in these terms and conditions.
				</p>

				<p>You must not:</p>
				<ul>
					<li>Republish material from danut-Shop</li>
					<li>Sell, rent or sub-license material from danut-Shop</li>
					<li>Reproduce, duplicate or copy material from danut-Shop</li>
					<li>Redistribute content from danut-Shop</li>
				</ul>
				...
				<p>
					...
					in certain areas of the website. danut-Shop does not filter, edit, publish or review Comments prior
					to their presence on the website. Comments do not reflect the views and opinions of danut-Shop,its
					agents and/or affiliates. Comments reflect the views and opinions of the person who post their views
					and opinions. To the extent permitted by applicable laws, danut-Shop shall not be liable for the
				...
				<p>
					danut-Shop reserves the right to monitor all Comments and to remove any Comments which can be
				...
				<p>
					You hereby grant danut-Shop a non-exclusive license to use, reproduce, edit and authorize others to
				...
				<p>
					...
					compensates the absence of danut-Shop; and (d) the link is in the context of general resource
					information.
				</p>
				...
				<p>
					...
					website, you must inform us by sending an e-mail to danut Shop. Please include your name, your
				...
				<p>
					No use of danut-Shop's logo or other artwork will be allowed for linking absent a trademark license
					agreement.
				</p>
